                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-8 b-r"><h3 class="m-t-none m-b">Add Brand</h3>
                            <form @submit.prevent="save()" role="form" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input v-model="brand.native_name" type="text" placeholder="Native brand Name"
                                           class="form-control">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
										<span class="btn btn-block btn-primary btn-file"><span class="fileinput-new"><i
                                            class="fa fa-camera"></i> Chose Logo</span>
										<span class="fileinput-exists">Change Logo</span><input type="file" name="..."
                                ...
                                <div style="margin-bottom: 20px;">
                                    <button class="btn btn-lg  btn-primary float-right " type="submit">
                                        <strong>{{ button_name }}</strong></button>
...
export default {
    ...
    methods: {
        ...
        save() {
            ...
            axios.post(base_url + 'admin/brand')
                .then(response => {
